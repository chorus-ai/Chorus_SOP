...
- Run the tool with the following command:
  ...
  python main.py
  ```
- Monitor the output for real-time feedback on privacy vulnerabilities. The tool generates a detailed report with a risk score highlighting any potential risk.
...
| `birthdate`           | 1.0                  | 100             |0.1             |Not Available          |
