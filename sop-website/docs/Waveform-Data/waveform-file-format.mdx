...
- An indication of whether the sample intervals are uniform across waveform types and channels. We expect that numerics files may have non-uniform sample intervals. High-frequency waveforms should have uniform sample intervals - if this is not the case in your submission please explain why not
