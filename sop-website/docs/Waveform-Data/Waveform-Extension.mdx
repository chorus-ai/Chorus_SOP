...
---
# <span style="color: red;">WARNING - Data contributing sites are not expected to deliver data in the waveform extension. Please refer to the Multimodal Linkage SOP [https://chorus-ai.github.io/Chorus_SOP/docs/Multimodal-Linkage/] for details on producing the waveform registry that is expected at this time. </span>
...
| 12    | is_feature_overflow              | boolean   | Optional               | Populate as TRUE if the feature was derived from signal segments that span multiple waveform files, waveform occurrences, or signal channels. This field helps downstream consumers account for composite or stitched features that cannot be strictly attributed to a single source. Leave NULL if undetermined.                                                              |
...
- **[03-13-25] Linking waveform and EHR data - Part 1**
  - [Video Recording](https://drive.google.com/file/d/1u11084E3psVNx1KsFj0m7cpis-l_WAwd/view?usp=share_link) | [Transcript](https://docs.google.com/document/d/1noFYSDrtOZYg-fiHE2bHgMpxTBHWXVL9/edit?usp=share_link&ouid=104468275537210259794&rtpof=true&sd=true)
  - Introduction to waveform and EHR data linkage methodology

- **[03-20-25] Linking waveform and EHR data - Part 2**
  - [Video Recording](https://drive.google.com/file/d/1mbPZ35yuJrOSWiLYEuz7YrEieXodmd00/view?usp=share_link) | [Transcript](https://docs.google.com/document/d/1-Dfaxd_D18b1U6VstUEffJvhH89mE-Lb/edit?usp=share_link&ouid=104468275537210259794&rtpof=true&sd=true)
  - Continued discussion on waveform-EHR data integration

- **[04-17-25] Waveform linkage and site updates**
  - [Video Recording](https://drive.google.com/file/d/1K2uF-pPrnutbxjh7LRm6pE4dkIK3rZtY/view?usp=share_link) | [Transcript](https://docs.google.com/document/d/1tsCTXEsxDw4TGkieQu7CZmjXlgxAzvJk/edit?usp=share_link&ouid=104468275537210259794&rtpof=true&sd=true)
  - Updates on waveform linkage implementation across sites

- **[06-26-25] Implementation of OMOP CDM Waveform Extension SOP**
  - [Video Recording](https://drive.google.com/file/d/15faSgQDdpkZP6Wz-J1dKoEqul6XUKcgR/view?usp=share_link) | [Transcript](https://docs.google.com/document/d/1fX5VCTc7z9lZZJNuMo60OJcuwGb7aEPM/edit?usp=share_link&ouid=104468275537210259794&rtpof=true&sd=true)
