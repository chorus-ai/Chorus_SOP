...
WARNING — Data contributing sites are not expected to deliver data in the waveform extension. Please refer to the Multimodal Linkage SOP <a href="https://chorus-ai.github.io/Chorus_SOP/docs/Multimodal-Linkage/">here</a> for details on producing the waveform registry that is expected at this time.
</span>
