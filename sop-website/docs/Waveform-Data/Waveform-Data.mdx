...
- Preferred signals in each telemetry waveform file (listed in order of priority):
  - Electrocardiogram (ECG)
  - Photoplethysmogram (PPG)
  - Respiratory / Impedance (RESP)
...
Additional signals which are of interest, along with standardized signal names for all telemetry signals being requested are available at <wiki_telemetry_link>.

### 4.2. Electroencephalogram waveforms

- Electroencephalogram (EEG) waveforms are also requested and should be in files independent of the telemetry waveforms. 

Please see <wiki_eeg_link> for standarized signal names for EEGs.

---

## 5. Data Format Requirements

### 5.1. Preferred Format: WFDB
