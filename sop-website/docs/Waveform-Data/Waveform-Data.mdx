...
- Required signals in each telemetry waveform file:
  - Electrocardiogram (i.e. ECG / EKG)
  - Photoplethysmogram (i.e. PPG)
- Recommended signals - to be included when available:
  - Intracranial pressure (i.e. ICP)
  - Respiratory / Impedance 
  - Ventilator
  - Brain oxygen
  - Arterial blood pressure
  - End tidal CO2 (i.e ETC02)
  - Central venous pressure
  - Pulmonary artery pressure

### 4.2. Electroencephalogram waveforms
- Electroencephalogram (i.e. EEG) waveforms are also requested and should be in files independent of the telemetry waveforms. 
