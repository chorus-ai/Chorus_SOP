...
- Distribute the delta table to the Standards Team using a preferred method:
  ...
  - **GitHub:** Upload a file with unmapped terms into `Unmapped-Terms` folder in the repository [chorus-mapping-stage](https://github.com/chorus-ai/chorus-mapping-stage).
