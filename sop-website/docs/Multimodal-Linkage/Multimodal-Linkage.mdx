...
The ways in which data are organized has been defined by the Data Acquisition team and is defined in the Data-Upload-Update SOP.

This organizational structure has been modified such that structured EHR data in OMOP CDM format are no longer included in the per-person file structure, as was recommended previously.
...
> **procedure_occurrence_id** is a unique identifier for a given row in the [PROCEDURE_OCCURRENCE table](https://ohdsi.github.io/CommonDataModel/cdm54.html#procedure_occurrence)
