...
5. Confirm the type of IDs used to link this data to the patient (e.g., name) or other hospital ID (e.g., MRN) => refer to Standards SOP about data linkage
...
8. Data quality review (e.g., data missingness) 
