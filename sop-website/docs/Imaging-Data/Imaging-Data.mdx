...
12. DICOM with metadata deidentified: to use a CHORUS-specific CTP version; DICOM files not to be shared until pixel deidentification solution devised unless site already has an approved solution.
