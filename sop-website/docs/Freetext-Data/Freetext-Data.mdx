...
2.	Store structured outputs in the NOTE_NLP table of the OMOP 5.4 CDM.
      -      The output of the OHNLP tool resembles, but does not exactly match, the CDM - update the NOTE_NLP table to match where necessary before submitting, including removing the matched_text and matched_sentence fields.
      -      Leave the snippet and lexical_variant fields blank in the NOTE_NLP table.
