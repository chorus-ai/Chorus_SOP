...
* Accession Id: The Accession number, may be a de-identified version of DICOM tags ***
...
This example would represent a CT scan for patient 1000100020 with Accession Number 1234 and Series Id 5678, with instance numbers 000, 001, and 002. This image is the first in that series. Please Make sure that these fields match the dicom metadata tags.
